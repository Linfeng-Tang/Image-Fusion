...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| DenseFuse | DenseFuse: A Fusion Approach to Infrared and Visible Images | 面向<br>视觉<br>融合 | AE | 自<br>监<br>督 | TIP | 2019 | [Paper](https://ieeexplore.ieee.org/abstract/document/8580578) | [Code](https://github.com/hli1221/imagefusion_densefuse) |
...
| RFN-Nest | RFN-Nest: An end-to-end residual fusion network for infrared and visible images | 面向<br>视觉<br>融合 | AE | 自<br>监<br>督 | InfFus | 2021 | [Paper](https://www.sciencedirect.com/science/article/pii/S1566253521000440) | [Code](https://github.com/hli1221/imagefusion-rfn-nest) |
| CSF | Classification Saliency-Based Rule for Visible and Infrared Image Fusion | 面向<br>视觉<br>融合 | AE | 自<br>监<br>督 | TCI | 2021 | [Paper](https://ieeexplore.ieee.org/abstract/document/9502544) | [Code](https://github.com/hanna-xu/CSF) |
...
| ReFusion | ReFusion: Learning Image Fusion from Reconstruction with Learnable Loss Via Meta-Learning | 退化<br>鲁棒<br>融合 | CNN | 自<br>监<br>督 | IJCV | 2024 | [Paper](https://link.springer.com/article/10.1007/s11263-024-02256-8) | [Code](https://github.com/HaowenBai/ReFusion) |
| IVF-WoReg | A Deep Learning Framework for Infrared and Visible Image Fusion Without Strict Registration | 联合<br>配准<br>融合 | CNN | 有<br>监<br>督 | IJCV | 2024 | [Paper](https://link.springer.com/article/10.1007/s11263-024-02263-9) | [Code](https://github.com/hanna-xu/IVF-WoReg) |
...
| FILM | Image Fusion via Vision-Language Model | 语义<br>驱动<br>融合 | CNN&<br>Transformer | 融合自监督<br>+<br>分割有监督 | ICML | 2024 | [Paper](https://arxiv.org/pdf/2402.02235) | [Code](https://github.com/Zhaozixiang1228/IF-FILM) |
| MRFS | MRFS: Mutually Reinforcing Image Fusion and Segmentation | 语义<br>驱动<br>融合 | CNN&<br>Transformer | 融合无监督<br>+<br>分割有监督 | CVPR | 2024 | [Paper](https://ieeexplore.ieee.org/document/10657039) | [Code](https://github.com/HaoZhang1018/MRFS) |
...
| CCF | Conditional Controllable Image Fusion | 联合<br>配准<br>融合 | Diffusion<br>Model | 无<br>监<br>督 | NeurIPS | 2024 | [Paper](https://proceedings.neurips.cc/paper_files/paper/2024/file/d99e8e80a6c41e148db686918dd7eab3-Paper-Conference.pdf) | [Code](https://github.com/jehovahxu/CCF) |
| TTD | Test-Time Dynamic Image Fusion | 面向<br>视觉<br>融合 | CNN | 无<br>监<br>督 | NeurIPS | 2024 | [Paper](https://proceedings.neurips.cc/paper_files/paper/2024/file/03dbc11a22e79cd38bea53cf518c2371-Paper-Conference.pdf) | [Code](https://github.com/Yinan-Xia/TTD) |
| ControlFusion | ControlFusion: A Controllable Image Fusion Network with Language-Vision Degradation Prompts | 语义<br>驱动<br>融合 | Transformer | 自<br>监<br>督 | NeurIPS | 2025 | [Paper](https://arxiv.org/pdf/2503.23356) | [Code](https://github.com/Linfeng-Tang/ControlFusion) |
| SAGE | Every SAMDrop Counts: Embracing Semantic Priors for Multi-Modality Image Fusion and Beyond | 语义<br>驱动<br>融合 | CNN | 融合无监督<br>+<br>分割有监督 | CVPR | 2025 | [Paper](https://arxiv.org/pdf/2503.01210) | [Code](https://github.com/RollingPlain/SAGE_IVIF) |
| DCEvo | DCEvo: Discriminative Cross-Dimensional Evolutionary Learning for Infrared and Visible Image Fusion | 语义<br>驱动<br>融合 | CNN | 融合自监督<br>+<br>分割有监督 | CVPR | 2025 | [Paper](https://ieeexplore.ieee.org/document/11093606) | [Code](https://github.com/Beate-Suy-Zhang/DCEvo) |
| TDFusion | Task-driven Image Fusion with Learnable Fusion Loss | 语义<br>驱动<br>融合 | CNN&<br>Transformer | 融合自监督<br>+<br>分割有监督 | CVPR | 2025 | [Paper](https://ieeexplore.ieee.org/abstract/document/11093987) | [Code](https://github.com/HaowenBai/TDFusion) |
...
| CDTFusion | CDTFusion: Crossing Domain and Task for Infrared and Visible Image Fusion | 面向<br>视觉<br>融合 | CNN | 域适配自监督<br>+<br>主体无监督 | TPAMI | 2025 | [Paper](https://ieeexplore.ieee.org/abstract/document/11181194/) | [Code](https://github.com/wangwenbo26/CDTFusion) |
...
# 多模图像融合(Multi-Modal Image Fusion)方法汇总
| 方法 | 论文标题 | 分类 | 基础框架 | 监督范式 | 发表期刊或会议 | 年份 | 论文 | 代码 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| DDcGAN | Learning a Generative Model for Fusing Infrared and Visible Images via Conditional Generative Adversarial Network with Dual Discriminators | 面向<br>视觉<br>融合 | GAN | 无<br>监<br>督 | IJCAI | 2019 | [Paper](https://www.ijcai.org/proceedings/2019/0549.pdf) | [Code](https://github.com/hanna-xu/DDcGAN) |
| DDFM | DDFM: Denoising Diffusion Model for Multi-Modality Image Fusion | 面向<br>视觉<br>融合 | Diffusion<br>Model | 无<br>监<br>督 | CVPR | 2023 | [Paper](https://ieeexplore.ieee.org/abstract/document/10376812) | [Code](https://github.com/Zhaozixiang1228/MMIF-DDFM) |
| CDDFuse | CDDFuse: Correlation-Driven Dual-Branch Feature Decomposition for Multi-Modality Image Fusion | 语义<br>驱动<br>融合 | CNN&<br>Transformer | 融合自监督<br>+<br>分割有监督 | CVPR | 2023 | [Paper](https://arxiv.org/pdf/2211.14461) | [Code](https://github.com/Zhaozixiang1228/MMIF-CDDFuse) |
| DRMF | DRMF: Degradation-Robust Multi-Modal Image Fusion via Composable Diffusion Prior | 面向<br>视觉<br>融合 | Diffusion<br>Model | 无<br>监<br>督 | ACM MM | 2024 | [Paper](https://dl.acm.org/doi/abs/10.1145/3664647.3681064) | [Code](https://github.com/Linfeng-Tang/DRMF) |
| CoCoNet | CoCoNet: Coupled Contrastive Learning Network with Multi-level Feature Ensemble for Multi-modality Image Fusion | 面向<br>视觉<br>融合 | CNN | 自<br>监<br>督 | IJCV | 2024 | [Paper](https://link.springer.com/article/10.1007/s11263-023-01952-1) | [Code](https://github.com/runjia0124/CoCoNet) |
| CCF | Conditional Controllable Image Fusion | 联合<br>配准<br>融合 | Diffusion<br>Model | 无<br>监<br>督 | NeurIPS | 2024 | [Paper](https://proceedings.neurips.cc/paper_files/paper/2024/file/d99e8e80a6c41e148db686918dd7eab3-Paper-Conference.pdf) | [Code](https://github.com/jehovahxu/CCF) |
| TTD | Test-Time Dynamic Image Fusion | 面向<br>视觉<br>融合 | CNN | 无<br>监<br>督 | NeurIPS | 2024 | [Paper](https://proceedings.neurips.cc/paper_files/paper/2024/file/03dbc11a22e79cd38bea53cf518c2371-Paper-Conference.pdf) | [Code](https://github.com/Yinan-Xia/TTD) |
| ReFusion | ReFusion: Learning Image Fusion from Reconstruction with Learnable Loss Via Meta-Learning | 退化<br>鲁棒<br>融合 | CNN | 自<br>监<br>督 | IJCV | 2024 | [Paper](https://link.springer.com/article/10.1007/s11263-024-02256-8) | [Code](https://github.com/HaowenBai/ReFusion) |
| IVF-WoReg | A Deep Learning Framework for Infrared and Visible Image Fusion Without Strict Registration | 联合<br>配准<br>融合 | CNN | 有<br>监<br>督 | IJCV | 2024 | [Paper](https://link.springer.com/article/10.1007/s11263-023-01948-x) | [Code](https://github.com/yuliu316316/IVF-WoReg) |
| C2RF | C2RF: Bridging Multi-modal Image Registration and Fusion via Commonality Mining and Contrastive Learning | 联合<br>配准<br>融合 | CNN | 自<br>监<br>督 | IJCV | 2025 | [Paper](https://link.springer.com/article/10.1007/s11263-025-02427-1) | [Code](https://github.com/Linfeng-Tang/C2RF) |
| MTG‑Fusion | Multi-Text Guidance Is Important: Multi-Modality Image Fusion via Large Generative Vision-Language Model | 语义<br>驱动<br>融合 | Diffusion<br>Model | 有<br>监<br>督 | IJCV | 2025 | [Paper](https://link.springer.com/article/10.1007/s11263-025-02409-3) | [Code](https://github.com/zhaolb4080/MTG-Fusion) |

# 通用图像融合(General Image Fusion)方法汇总
| 方法 | 论文标题 | 场景 | 基础框架 | 监督范式 | 发表期刊或会议 | 年份 | 论文 | 代码 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| IFCNN | IFCNN: A general image fusion framework based on convolutional neural network | 通用<br>图像<br>融合 | CNN | 有<br>监<br>督 | InfFus | 2020 | [Paper](https://www.sciencedirect.com/science/article/pii/S1566253518305505) | [Code](https://github.com/uzeful/IFCNN) |
| PMGI | Rethinking the Image Fusion: A Fast Unified Image Fusion Network based on Proportional Maintenance of Gradient and Intensity | 通用<br>图像<br>融合 | CNN | 无<br>监<br>督 | AAAI | 2020 | [Paper](https://ojs.aaai.org/index.php/AAAI/article/view/6975) | [Code](https://github.com/HaoZhang1018/PMGI_AAAI2020) |
| SDNet | SDNet: A Versatile Squeeze-and-Decomposition Network for Real-Time Image Fusion | 通用<br>图像<br>融合 | CNN | 无<br>监<br>督 | IJCV | 2021 | [Paper](https://link.springer.com/article/10.1007/s11263-021-01501-8) | [Code](https://github.com/HaoZhang1018/SDNet) |
| U2Fusion | U2Fusion: A Unified Unsupervised Image Fusion Network | 通用<br>图像<br>融合 | CNN | 无<br>监<br>督 | TPAMI | 2022 | [Paper](https://ieeexplore.ieee.org/abstract/document/9151265/) | [Code](https://github.com/hanna-xu/U2Fusion) |
...
| DeFusion | Fusion from Decomposition: A Self-Supervised Decomposition Approach for Image Fusion | 通用<br>图像<br>融合 | CNN | 无<br>监<br>督 | ECCV | 2022 | [Paper](https://link.springer.com/chapter/10.1007/978-3-031-19797-0_41) | [Code](https://github.com/erfect2020/DecompositionForFusion) |
...
| GIFNet | One Model for ALL: Low-Level Task Interaction Is a Key to Task-Agnostic Image Fusion | 通用<br>图像<br>融合 | Transformer | 无监督&有监督 | CVPR | 2025 | [Paper](https://arxiv.org/pdf/2502.19854) | [Code](https://github.com/AWCXV/GIFNet) |
