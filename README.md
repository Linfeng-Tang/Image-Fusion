...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| DenseFuse | DenseFuse: A Fusion Approach to Infrared and Visible Images | 面向视觉的融合 | AE | 自<br>监<br>督 | TIP | 2019 | [Paper](https://ieeexplore.ieee.org/abstract/document/8580578) | [Code](https://github.com/hli1221/imagefusion_densefuse) |
| FusionGAN | FusionGAN: A generative adversarial network for infrared and visible image fusion | 面向视觉的融合 | GAN | 无<br>监<br>督 | InfFus | 2019 | [Paper](https://www.sciencedirect.com/science/article/pii/S1566253518301143) | [Code](https://github.com/jiayi-ma/FusionGAN) |
| RFN-Nest | RFN-Nest: An end-to-end residual fusion network for infrared and visible images | 面向视觉的融合 | AE | 自<br>监<br>督 | InfFus | 2021 | [Paper](https://www.sciencedirect.com/science/article/pii/S1566253521000440) | [Code](https://github.com/hli1221/imagefusion-rfn-nest) |
| CSF | Classification Saliency-Based Rule for Visible and Infrared Image Fusion | 面向视觉的融合 | AE | 自<br>监<br>督 | TCI | 2021 | [Paper](https://ieeexplore.ieee.org/abstract/document/9502544) | [Code](https://github.com/hanna-xu/CSF) |
| SeAFusion | Image fusion in the loop of high-level vision tasks: A semantic-aware real-time infrared and visible image fusion network | 语义驱动的融合 | CNN | 无<br>监<br>督 | InfFus | 2022 | [Paper](https://www.sciencedirect.com/science/article/pii/S1566253521002542) | [Code](https://github.com/Linfeng-Tang/SeAFusion) |
| TarDAL | Target-aware Dual Adversarial Learning and a Multi-scenario Multi-Modality Benchmark to Fuse Infrared and Visible for Object Detection | 语义驱动的融合 | GAN | 无<br>监<br>督 | CVPR | 2022 | [Paper](https://ieeexplore.ieee.org/document/9879642) | [Code](https://github.com/JinyuanLiu-CV/TarDAL) |
| PAIF | PAIF: Perception-Aware Infrared-Visible Image Fusion for Attack-Tolerant Semantic Segmentation | 语义驱动的融合 | CNN | 无<br>监<br>督 | ACM MM | 2023 | [Paper](https://dl.acm.org/doi/abs/10.1145/3581783.3611928) | [Code](https://github.com/LiuZhu-CV/PAIF) |
| MURF | MURF: Mutually Reinforcing Multi-Modal Image Registration and Fusion | 联合配准的融合 | CNN | 无<br>监<br>督 | TPAMI | 2023 | [Paper](https://ieeexplore.ieee.org/abstract/document/10145843) | [Code](https://github.com/autonomousvision/murf) |
| LRRNet | LRRNet: A Novel Representation Learning Guided Fusion Network for Infrared and Visible Images | 面向视觉的融合 | CNN | 有<br>监<br>督 | TPAMI | 2023 | [Paper](https://ieeexplore.ieee.org/abstract/document/10105495) | [Code](https://github.com/hli1221/imagefusion-LRRNet) |
| PSFusion | Rethinking the necessity of image fusion in high-level vision tasks: A practical infrared and visible image fusion network based on progressive semantic injection and scene fidelity | 语义驱动的融合 | CNN | 无<br>监<br>督 | InfFus | 2023 | [Paper](https://www.sciencedirect.com/science/article/pii/S1566253523001860) | [Code](https://github.com/Linfeng-Tang/PSFusion) |
| SegMiF | Multi-interactive Feature Learning and a Full-time Multi-modality Benchmark for Image Fusion and Segmentation | 语义驱动的融合 | CNN&<br>Transformer | 有<br>监<br>督 | ICCV | 2023 | [Paper](https://ieeexplore.ieee.org/document/10377908) | [Code](https://github.com/JinyuanLiu-CV/SegMiF) |
| ReFusion | ReFusion: Learning Image Fusion from Reconstruction with Learnable Loss Via Meta-Learning | 退化鲁棒的融合 | CNN | 自<br>监<br>督 | IJCV | 2024 | [Paper](https://link.springer.com/article/10.1007/s11263-024-02256-8) | [Code](https://github.com/HaowenBai/ReFusion) |
| IVF-WoReg | A Deep Learning Framework for Infrared and Visible Image Fusion Without Strict Registration | 联合配准的融合 | CNN | 有<br>监<br>督 | IJCV | 2024 | [Paper](https://link.springer.com/article/10.1007/s11263-024-02263-9) | [Code](https://github.com/hanna-xu/IVF-WoReg) |
| TC‑MoA | Task-Customized Mixture of Adapters for General Image Fusion | 面向视觉的融合 | Transformer | 无<br>监<br>督 | CVPR | 2024 | [Paper](https://ieeexplore.ieee.org/document/10655024) | [Code](https://github.com/YangSun22/TC-MoA) |
| FILM | Image Fusion via Vision-Language Model | 语义驱动的融合 | CNN&<br>Transformer | 融合自监督<br>+<br>分割有监督 | ICML | 2024 | [Paper](https://arxiv.org/pdf/2402.02235) | [Code](https://github.com/Zhaozixiang1228/IF-FILM) |
| MRFS | MRFS: Mutually Reinforcing Image Fusion and Segmentation | 语义驱动的融合 | CNN&<br>Transformer | 融合无监督<br>+<br>分割有监督 | CVPR | 2024 | [Paper](https://ieeexplore.ieee.org/document/10657039) | [Code](https://github.com/HaoZhang1018/MRFS) |
| Text-IF | Text-IF: Leveraging Semantic Text Guidance for Degradation-Aware and Interactive Image Fusion | 语义驱动的融合 | Transformer | 无<br>监<br>督 | CVPR | 2024 | [Paper](https://ieeexplore.ieee.org/document/10656870) | [Code](https://github.com/XunpengYi/Text-IF) |
| CCF | Conditional Controllable Image Fusion | 联合配准的融合 | Diffusion<br>Model | 无<br>监<br>督 | NeurIPS | 2024 | [Paper](https://proceedings.neurips.cc/paper_files/paper/2024/file/d99e8e80a6c41e148db686918dd7eab3-Paper-Conference.pdf) | [Code](https://github.com/jehovahxu/CCF) |
| TTD | Test-Time Dynamic Image Fusion | 面向视觉的融合 | CNN | 无<br>监<br>督 | NeurIPS | 2024 | [Paper](https://proceedings.neurips.cc/paper_files/paper/2024/file/03dbc11a22e79cd38bea53cf518c2371-Paper-Conference.pdf) | [Code](https://github.com/Yinan-Xia/TTD) |
| ControlFusion | ControlFusion: A Controllable Image Fusion Network with Language-Vision Degradation Prompts | 语义驱动的融合 | Transformer | 自<br>监<br>督 | NeurIPS | 2025 | [Paper](https://arxiv.org/pdf/2503.23356) | [Code](https://github.com/Linfeng-Tang/ControlFusion) |
| SAGE | Every SAMDrop Counts: Embracing Semantic Priors for Multi-Modality Image Fusion and Beyond | 语义驱动的融合 | CNN | 融合无监督<br>+<br>分割有监督 | CVPR | 2025 | [Paper](https://arxiv.org/pdf/2503.01210) | [Code](https://github.com/RollingPlain/SAGE_IVIF) |
| DCEvo | DCEvo: Discriminative Cross-Dimensional Evolutionary Learning for Infrared and Visible Image Fusion | 语义驱动的融合 | CNN | 融合自监督<br>+<br>分割有监督 | CVPR | 2025 | [Paper](https://ieeexplore.ieee.org/document/11093606) | [Code](https://github.com/Beate-Suy-Zhang/DCEvo) |
| TDFusion | Task-driven Image Fusion with Learnable Fusion Loss | 语义驱动的融合 | CNN&<br>Transformer | 融合自监督<br>+<br>分割有监督 | CVPR | 2025 | [Paper](https://ieeexplore.ieee.org/abstract/document/11093987) | [Code](https://github.com/HaowenBai/TDFusion) |
| Dream‑IF | Dream-IF: Dynamic Relative EnhAnceMent for Image Fusion | 退化鲁棒的融合 | CNN&<br>Transformer | 有<br>监<br>督 | arXiv | 2025 | [Paper](https://arxiv.org/pdf/2503.10109) | [Code](https://github.com/jehovahxu/Dream-IF) |
| FreeFusion | FreeFusion: Infrared and Visible Image Fusion via Cross Reconstruction Learning | 退化鲁棒的融合 | CNN | 有<br>监<br>督 | TPAMI | 2025 | [Paper](https://ieeexplore.ieee.org/abstract/document/11010882) | [Code](https://github.com/HengshuaiCui/FreeFusion) |
| MulFS-CAP | MulFS-CAP: Multimodal Fusion-Supervised Cross-Modality Alignment Perception for Unregistered Infrared-Visible Image Fusion | 语义驱动的融合 | CNN | 有<br>监<br>督 | TPAMI | 2025 | [Paper](https://ieeexplore.ieee.org/abstract/document/10856402) | [Code](https://github.com/YR0211/MulFS-CAP) |
| CDTFusion | CDTFusion: Crossing Domain and Task for Infrared and Visible Image Fusion | 面向视觉的融合 | CNN | 域适配自监督<br>+<br>主体无监督 | TPAMI | 2025 | [Paper](https://ieeexplore.ieee.org/abstract/document/11181194/) | [Code](https://github.com/wangwenbo26/CDTFusion) |
| OmniFuse | OmniFuse: Composite Degradation-Robust Image Fusion With Language-Driven Semantics | 联合配准的融合 | Diffusion<br>Model | 有<br>监<br>督 | TPAMI | 2025 | [Paper](https://ieeexplore.ieee.org/abstract/document/10994384/) | [Code](https://github.com/yuliangguo/OmniFusion) |
| FusionBooster | FusionBooster: A Unified Image Fusion Boosting Paradigm | 语义驱动的融合 | AE | 有<br>监<br>督 | IJCV | 2025 | [Paper](https://link.springer.com/article/10.1007/s11263-024-02266-6) | [Code](https://github.com/AWCXV/FusionBooster) |
| OCCO | OCCO: LVM-Guided Infrared and Visible Image Fusion Framework Based on Object-Aware and Contextual Contrastive Learning | 联合配准的融合 | CNN | 有<br>监<br>督 | IJCV | 2025 | [Paper](https://link.springer.com/article/10.1007/s11263-025-02507-2) | [Code](https://github.com/bociic/OCCO) |
